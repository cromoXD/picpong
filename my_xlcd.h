...
#define DELAY_SINC		11
#define DELAY_INICIO	180	//(15ms)
 ...
 *****************************************************************************/
 extern void XLCD_executar(unsigned char cmd);
 ...
 *****************************************************************************/
 extern void XLCD_escrever_byte(char data);
 ...
 *****************************************************************************/
 extern void XLCD_posicionar(unsigned char DDAddr);
 ...
 *				SetDDRamAddr().
 *****************************************************************************/
 extern void XLCD_escrever_string(char *buffer);
 ...
 *				SetDDRamAddr().
 *****************************************************************************/
 extern void XLCD_escrever_rom_string(const rom char *buffer);


/**
 * Limpa a tela
 */
 extern void XLCD_limpar(void);
 
/**
 * Inicia a escrita na CGRAM
 */
 extern void XLCD_CGRAM(void);
